...
class SupplierController extends Controller
{
    ...
    {
        $koneksi = DB::connection("mysql")->table("supplier")->get();
    ...
    public function create(Request $request)
    {
        ...
        $koneksi = DB::connection("mysql")->table("supplier")->insert($request->all());
    ...
    {
        $koneksi = DB::connection("mysql")->table("supplier")->find($id);
        if ($koneksi == NULL){
    ...
    {
        $koneksi = DB::connection("mysql")->table("supplier")->where("id",$id)->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($koneksi == NULL){
            ...
            $timestamp = \Carbon\Carbon::now()->toDateTimeString();
            $koneksi = DB::connection("mysql")->table("supplier")->where("id",$id)->update($request->all());
            $request["updated_at"] = $timestamp;
    ...
    public function destroy($id)
    {
        ...
        if ($koneksi == NULL){
            ...
            $koneksi = DB::connection("mysql")->table("supplier");
            $koneksi->find($id);
            $koneksi->delete($id);
